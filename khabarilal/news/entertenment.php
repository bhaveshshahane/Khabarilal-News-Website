<?php
include "query.php";
$sql = "select * from newsTable where categories='entertenment' order by newsId desc limit 4;";
$entertenment = mysqli_query($con,$sql);
?>
...
<section class="py-3 py-md-5">
    ...
    <?php
    $rowcount=mysqli_num_rows($entertenment);
   if($rowcount!==0){
    while($row = mysqli_fetch_assoc($entertenment)){
      ?>
...
<?php }}else{?>
 ...
 <h5 id="msg" class="mt-2 fw-light">Record Not Found!</h5>
<?php } ?>
     </div>
    </div>
  </section>

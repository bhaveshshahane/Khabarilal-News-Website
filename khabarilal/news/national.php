<?php
include "query.php";
$sql = "select * from newsTable where categories='national' order by newsId desc limit 4;";
$national = mysqli_query($con,$sql);
?>
...
<section class="py-3 py-md-5">
    ...
    <div class="container overflow-hidden">
      ...
      <?php
    $rowcount=mysqli_num_rows($national);
   if($rowcount!==0){
    while($row = mysqli_fetch_assoc($national)){
      ?>

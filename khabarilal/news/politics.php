<?php
include "query.php";
$sql = "select * from newsTable where categories='politics' order by newsId desc limit 4;";
$politics = mysqli_query($con,$sql);
?>
...
<section class="py-3 py-md-5">
    ...
    <div class="container overflow-hidden">
      ...
      <?php
    $rowcount=mysqli_num_rows($politics);
   if($rowcount!==0){
    while($row = mysqli_fetch_assoc($politics)){
      ?>
